...
global _gdt_flush     ; leidžia C kodui naudotis šia funkcija
extern _gp            ;  nurodo, kad gp kintamasis apibrėžtas kitame faile
_gdt_flush:
...
isr_common_stub:
    ...
    mov eax, esp
    push eax
    mov eax, fault_handler	; užkrauna branduolio duomenų segmento deskriptorių
    call eax
    pop eax
    pop gs
    pop fs
    ...
    iret       ; iš steko paima penkias reikšmes: CS, EIP, EFLAGS, SS ir ESP
...
irq0:
    ...
    push byte 32	; kad būtų išlaikytas vientisumas
    jmp irq_common_stub
...
; Veikia labai panašiai kaip PAP žymė "isr_common_stub"
;Iiškviečia funkciją esančią faile "irc.c"
irq_common_stub:
    pusha
    push ds
    push es
